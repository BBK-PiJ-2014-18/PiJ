...
test.setRow(3,str);
test.prettyPrint();
System.out.println("get a new blank 6 x 3 matrix");
...
System.out.println("get a new blank 5 x 6 matrix");
...
test3.prettyPrint();
//trying toAString
String strOut = test3.toAString();
System.out.println("As a string: " + strOut);
