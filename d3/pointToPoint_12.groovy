...
//System.out.println("dist first and second is: " + distanceFirstSecond);
//System.out.println("dist second and third is: " + distanceSecondThird);
//System.out.println("dist first and third is: " + distanceFirstThird);
...
if(distanceSecondThird < distanceFirstSecond && distanceSecondThird < distanceFirstThird) {
	System.out.println("Second and Third are nearest");
} 
if(distanceFirstThird < distanceSecondThird && distanceFirstThird < distanceFirstSecond) {
